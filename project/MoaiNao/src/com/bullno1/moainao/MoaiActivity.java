...
public class MoaiActivity extends Activity {
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
		...
		MoaiLog.i("Mounting: " + uri.toString());
		
		Moai.mount("bundle/assets/lua", uri.toString().substring(7));//remove file://
	    ...
	    mMoaiView = new MoaiView ( this, display.getWidth (), display.getHeight (), info.reqGlEsVersion, mIsLandscape );
